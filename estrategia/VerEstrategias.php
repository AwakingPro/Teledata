                                    ...
                                    <div class="col-sm-2">
                                        <div id="DivTipo">
                                            <select class="selectpicker"  id="SeleccioneTipoEstrategia" data-width="100%">
                                                ...
                                                <option value="0">Tipo Estática</option>
                                                <option value="1">Tipo Dinámica</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-heading">
                                        <h2 class="panel-title"> <i class="fa fa-code-fork"></i> Resultado de Segmentación para la Estrategia : <b><?php echo $NombreEstrategia;?></b> <button class="btn btn-danger btn-icon icon-sm fa fa-trash pull-right " id="Deshacer"></button> <button class="btn btn-success btn-icon icon-sm fa fa-refresh pull-right " id="Actualizar"></button></h2>
                                </div>
                                <div class="panel-body">
