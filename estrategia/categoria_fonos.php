...
$objetoSession->crearVariableSession($array = array("idMenu" => "est,ccf"));
							...
							<div class="col-sm-12 eq-box-sm">
                                ...
                                <div class="panel" id='padre'>
									<div class="panel-heading">
									 <h2 class="panel-title"> Crear Categoria de Fono</h2>
									</div>
                                   ...
                                   <form action="" id="categoria" method="post">
                                        ...
                                        <?php $result=mysql_query("SELECT * FROM Tipo_Contacto WHERE mundo = 1");
                                    ...
                                    <div class="col-sm-1">
                                     ...
                                     <div class="col-sm-1">
                                       ...
                                       <div class="col-sm-2">
                                       <input type="hidden" name='mundo' value='1' id='mundo'>
                                  ...
                                  <?php $ver = mysql_query("SELECT  * FROM SIS_Categoria_Fonos WHERE sel = 0 AND mundo = 1");
                                                $contar = mysql_num_rows($ver);
                                                if($contar>0){
                                                ?>
                                  <div class="panel-heading">
									 <h2 class="panel-title"> Categorías Creadas</h2>
									</div>
                                    <div class="panel-body">
                                                ...
                                                <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $query_fonos = mysql_query("SELECT * FROM SIS_Categoria_Fonos WHERE sel = 0 AND mundo = 1");
                                              ...
                                              <div class="col-sm-2">
                                                ...
                                                <form action="#" id="java" method="POST">
