$(document).ready(function () {
    ...
    var rut_dial = $('#rut_dial').val();
    var cedente_dial = $('#cedente_dial').val();
    ...
    if (id_dial == 1) {
        ...
        //--FIN: Control no encontrado

        $('#AddCorreoN').on('click', function () {
    ...
    $.niftyNoty({
        ...
        $('#AddCorreoNcc').on('click', function () {
    console.log("paso aqui");
    var resp = '';
    var data = 'id=1';
    ...
    $.niftyNoty({
        ...
        $('#nuevo_direccion').on('click', function () {
            bootbox.dialog({
        ...
        $('#nuevo_correo2 ').on('click', function () {
            var resp = '';
            var data = 'id=1';
            $.ajax(
			{
    ...
    $.ajax(
			{
			    ...
			    success: function (response) {
			        console.log(response);
			        if (response.uno == 0) {
			            alert('Combinacion Rut Cedente No Existe!');
			            funcionLimpiar();
			        }
			        else {
			            console.log('por aca');
        ...
        $('#seleccione_tipo_busqueda').on('change',  function () {
        ...
        $('#seleccione_cedente2').on('change', function () {
            var id = $('#seleccione_cedente2').val();
            console.log(id);
            $('#cedente').val(id);
            limpiarSesion();
        });
        $('#seleccione_cedente').on('change', function () {
            limpiarSesion();
