...
$(document).ready(function($) 
{
	$("#nivel1").change(function() 
    {
    	...
    	{
         	type: "POST",
        	url: "../includes/crm/nivel1.php",
         	data:id_nivel1, 
         	success: function(response)
            {	
			 	$("#midiv").show();
			 	$("#ocultar").html(response);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {               
                                    ...
                                    var data = 'nivel1='+nivel1+'&hora='+hora+'&fecha_agendamiento='+fecha_agendamiento+'&rut='+rut+'&fono='+fono+'&observacion='+observacion+'&monto='+monto+'&record='+record+'&id_personal='+id_personal;
                                    $.ajax(
                                    {
                                        type: "POST",
                                        url: "../includes/crm/insert.php",
                                        data:data, 
                                        success: function(response)
                                        {
