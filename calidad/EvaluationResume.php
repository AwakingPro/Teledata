        ...
        <div class="row" style="margin: 0 10px;">
            ...
            <table cellspacing="0">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        ?>
                            <tr style="padding: 10px 0px; background-color: #f9f9f9;">
                                <td style="padding: 10px 5px;" width=323><?php echo $Detail["Descripcion"]; ?></td>
                    ...
                    <tr style="padding: 10px 0px; background-color: #273441; color: #FFFFFF">
                        <td style="padding: 10px 5px;" width=323 align=right>TOTAL:</td>
            ...
            <table cellspacing="0" width=800>
                <tr style="background-color: #273441; color: #FFFFFF">
                    <td width=750 style="padding: 10px 5px;">ASPECTOS A FORTALECER</td>
                </tr>
                <tr>
                    <td width=750 style="padding: 10px 5px; 20px 5px">
                        <?php echo $Evaluation["Aspectos_Fortalecer"]; ?> 
                    </td>
                </tr>
                <tr style="background-color: #273441; color: #FFFFFF">
                    <td width=750 style="padding: 10px 5px;">ASPECTOS A CORREGIR</td>
                </tr>
                <tr>
                    <td width=750 style="padding: 10px 5px; 20px 5px">
                ...
                <tr style="background-color: #273441; color: #FFFFFF">
                    <td width=750 style="padding: 10px 5px;">COMPROMISO DEL EJECUTIVO</td>
                </tr>
                <tr>
                    <td width=750 style="padding: 10px 5px; 20px 5px">
