						...
						<div class="eq-height">
							...
							<div class="col-sm-12 eq-box-sm">
                                ...
                                <!--AUDIOJS [ REQUIRED ]-->
                                                ...
                                                <div class="Table">
                                                    ...
                                                    <table id="Evaluations" class="display" cellspacing="0" width="100%">
                                                        <thead>
                                                            ...
                                                            <th>Observación</th>
                                                            <th>Actions</th>
                                                            <th style="display: none">ObservacionText</th>
                                                        </thead>
                                                        <tbody></tbody>
                                                        <tfoot>
                                                            <th></th>
                                    ...
                                    <script id="RecordGroupsTemplate" type="text/template">
                                        <div class="row">
                                            <div class="cols-sm-1">
                                                <div class="Table">
                                                    <table id="RecordGroupsTable" class="display" cellspacing="0" width="100%">
                                                        <thead>
                                                            <th>Grabación</th>
                                                            <th>Fecha Evauación</th>
                                                            <th>Ponderación</th>
                                                            <th>Nota</th>
                                                            <th>Calificación Ponderada</th>
                                                        </thead>
