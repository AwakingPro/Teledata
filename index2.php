...
$objeto = new Session('1',false);
$loginFormAction = $_SERVER['PHP_SELF'];
if (isset($_GET['accesscheck']))
{
  $objeto->crearVariableSessionPrevUrl($_GET['accesscheck']);
}
if (isset($_POST['usuario']))
{
	$objeto->login($_POST['usuario'],$password=$_POST['password'],$conn,$database_name);
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
	<div id="container" class="cls-container">
		...
		<div class="cls-content">
            ...
            <br>
            <?php
						if(isset($_GET['id'])==1){ echo "<span class='text-danger'>Usuario o Contraseña Incorrectos!</span>"; } else {}?>
					</form>
				</div>
			</div>
			<div class="pad-ver">
				<a href="#" class="btn-link mar-rgt">Olvidaste tu Contraseña?</a>
			</div>
		</div>
		<!--===================================================-->
