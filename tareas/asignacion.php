        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div id="page-content">
                            ...
                            <div class="row">
                                <div class="eq-height">
                                    <div class="col-sm-12 eq-box-sm">
                                        <div class="panel" id='padre'>
                                            <div class="panel-heading">
                                             <h2 class="panel-title"> Seleccione Acción Principal</h2>
                                            </div>
                                                <div class="panel-body">
                                                    <div id="cambiar4">
                                                        <div class="row">
                                                        <form action="index.php" method="post" id="acciones">
                                                         <div class="col-sm-2">
                                                                    <div>
                                                                        <select class="select1"  id="accion" name="accion" title="Seleccione" data-width="100%">
                                                                        <option value=1>Telefónica</option>
                                                                        <option value=2>SMS</option>
                                                                        <option value=3>Correo</option>
                                                                        <option value=4>IVR Voz</option>
                                                                        </select>
                                                                    </div>
                                                            </div>
                                                            <div class="col-sm-2">
                                                            ...
                                                            <div class="col-sm-2">
                                                            <input type="number" id="cant" name="cant" class='text1' placeholder="Cant Gestiones Sin éxito">                                        </div>
                                                            <div id='id_nuevos'></div>
                                                            <div class="col-sm-2">
                                                                
                                                                                                                                                															<select class="select1" name="exito" id="exito" title="Seleccione" data-width="100%">
                                                                        <option value=0>Seleccione éxito</option>
                    ...
                    <div id="acciones_seleccionadas2">               
                        <div class="row">
                            <div class="eq-height">
                                <div class="col-sm-12 eq-box-sm">
                                    <div class="panel" id='padre'>
                                        <div class="panel-heading">
                                         <h2 class="panel-title">Acciones Seleccionadas</h2>
                                        </div>
                                            <div class="panel-body">
                                                 <div id="acciones_seleccionadas"> 
                                                 </div>
                                            </div>
                                    </div>
                                </div>
                                                ...
                                                <table id="demo-dt-basic10" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                   <thead>
                                                    <tr>
                                                     ...
                                                     <th class="min-desktop"><center>Champion Challenger</center></th>
                                                     <th class="min-desktop"><center>% Champion Challenger</center></th>
                                                  ...
                                                  <tbody>
                                                            ...
                                                            <div class="row">       
                                                                <div class="col-sm-3">
                                                                    <div class="form-group">
                                                                        <input type="submit" id="smt" class="btn btn-primary btn-block" value="Generar Asignación"> 
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                </form>               
