    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <form class="form-horizontal" id = "asignarTareas">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="select">
                                    <select class="selectpicker form-control" name="IdUsuarioAsignado" id="IdUsuarioAsignado"  data-live-search="true" data-container="body">
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer p-b-20 m-b-20">
                <div class="col-sm-12">
                    <button type="button" class="btn btn-purple" id="Asignar" name="guardarTarea">Asignar</button>
                </div>
            </div></form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div id="modalTarea" class="modal fade" tabindex="-1" role="dialog" id="load">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gris-oscuro p-t-10 p-b-10">
                <h4 class="modal-title c-negro">Código: <span id="Codigo"></span> <button type="button" data-dismiss="modal" class="close c-negro f-25" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></h4>
            </div>
            <div class="modal-body">
                <div class="row" style="padding:20px">
