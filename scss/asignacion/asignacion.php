        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div id="page-content">
                    ...
                    <div id="gestores_seleccionados">               
                        <div class="row">
                            <div class="eq-height">
                                <div class="col-sm-12 eq-box-sm">
                                    <div class="panel" id='padre'>
                                        <div class="panel-heading">
                                         <h2 class="panel-title"> Gestores Seleccionados</h2>
                                        </div>
                                            <div class="panel-body">
                                                <div id="cambiar20">
                                                 <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                              ...
                                              $sql = mysql_query("SELECT id,nombre FROM SIS_Gestores WHERE seleccion=1");
                                               ...
                                               <td><?php echo $row[0];?></td>
                                               <td><?php echo $row[1];?></td>
                                               <td><center><a href='#' class='eliminar_gestores2'><i class='fa fa-close icon-lg' > </i></a></center></td>
                                               </tr> 
                                               <?php 
                                                }
                                              ?>  
