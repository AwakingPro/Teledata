                    ...
                    <div id="mainnav-menu-wrap">
                        <div class="nano">
                            <div class="nano-content">
                                ...
                                <?php if($arrMenu[1] == "ges_dia"){
		                                	echo "<li class='active-link'>";}
		                                    else { ?>
		                                    <li>
		                                	<?php } ?>
						                    <a href="../crm/gestiones_dia.php">Gestion Diaria</a>
						                    </li>
                                <?php if($arrMenu[1] == "ges_ran"){
		                                	echo "<li class='active-link'>";}
		                                    else { ?>
		                                    <li>
		                                	<?php } ?>
						                    <a href="../crm/gestiones_rango.php">Gestion Periodo</a>
						                    </li>
...
?>
>>>>>>> 983448d45ec091242700d47f900ed509b7c909b6
