          ...
          <div id="page-content">
            ...
            <div class="row">
                  ...
                  <div class="panel" id='sql'>
                      <div class="panel-heading">
                        <h2 class="panel-title" id="titulo_usu"><i class="fa fa-pencil-square-o"></i><?php echo $tituloVentana; ?></h2>
                      </div>
                      <!-- Panel model -->
                      <!--===================================================-->
                      <div class="panel-body">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="panel-heading">
                                <h1 class="panel-title" id="titulo_domicilio">Domicilio</h1>
                                <br>
                              </div>
                              <div class="col-sm-9">
                                <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="panel-heading">
                                <h1 class="panel-title" id="titulo_contactos">Contactos</h1>
                                <br>
                              </div>
                            </div>
                            <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="panel-heading">
                                <h1 class="panel-title" id="titulo_contactos">Datos Previsionales</h1>
                                <br>
                              </div>
                            </div>
                            <div class="row">
                          ...
                          <div class="row" >
                            ...
                            <div class="col-sm-2">
                              <div class="form-group" >
                                ...
                                <input id="<?php echo $creaModificaUsua; ?>" type="submit" class="btn btn-primary btn-block" value="Guardar Usuario">
                              </div>
                            </div>
                            <div class="col-sm-2" >
                              <div class="form-group" >
                                <input type="button" class="btn btn-primary btn-block" value="Volver" onClick="location.href = 'usuarios.php' ">
                              </div>
                            </div>
                          </div>
                          <div class="row">
