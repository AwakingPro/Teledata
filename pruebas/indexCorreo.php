                                ...
                                <tr>
                                    ...
                                    <td class='wrapper'>
                                        <table class='twelve columns'>
                                            <tr>
                                                <td class='last'>
                                                    <h4>Cambiar Campo(s) TipoFactura = 4 en la BD.</h4>
                                                    <?php
                                                    $total = 15;
                                                    $dataClient['MensajeCorreo'] = 'Se encontraron '.$total;
                                                    ...
                                                    ?>
                                                    <p class='m-b-5'><?php echo $dataClient['MensajeCorreo']; ?></p>
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                                <td class='panel'>
                                ...
                                <tr>
                                    ...
                                    <td class='wrapper'>
                                        ...
                                        <table class='twelve columns'>
                                            <tr>
                                                <td>
                                                    <h4>Uso del campo TipoFactura</h4>
                                                    <p>
                                                      1 - En la tabla de facturas el TipoFactura = 1 es para facturas de servicios individuales generados por nota de venta, estas saldran en facturacion individual
                                                    </p>
                                                    <p>
                                                      2 - En la tabla de facturas el TipoFactura = 2 es para facturas de servicios que pueden ser con grupo, grupo con oc, sin grupo, estas saldran en por facturacion por lotes
                                                    </p>
                                                    <p>
                                                      3 - En la tabla de facturas el TipoFactura = 3 es para facturas de Instalacion individuales generados por nota de venta, estas saldran en facturacion individual
                                                    </p>
                                                    <p>
                                                      4 - Fue encontrada en bsale pero no en el ERP y por lo tanto fue sincronizada.
                                                    </p>
                                                    <p style='text-align:center !important;'  >
                                                        <a href='http://teledata.cl/' target='_blank'><img style='display:center !important; float:center !important;' src='http://teledata.cl/images_web/logo-teledata-200.png' /></a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
