                        ...
                        <div class="col-lg-12">
                            <div class="panel" id="demo-panel-collapse" class="collapse in">
                             <div class="panel-heading">
                                        <h3 class="panel-title bg-primary">Tipo de Busqueda</h3>
                                    </div>
                                <div class="panel-body ">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="sel1">Seleccione Tipo De Busqueda</label>
                                            <select class="select2" id="seleccione_tipo_busqueda"  disabled="disabled" name="tipo_estrategia" >
                                                <option value="0">Discador Predictivo</option>
                                    ...
                                    <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="sel1">Seleccione Cedente</label>
                                                    <?php
                                                        $mostrarCedente = new crm();
                                                        $mostrarCedente->mostrarCedente2();
                                                    ?>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="sel1">Ingrese Rut</label>
                                                    <input type="text" value=""   class="form-control" id="rut_buscado">
                                            </div>
                                        </div>

                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="sel1">Buscar Rut</label>
                                    ...
                                    <div class="panel-body ">
                                        <div class="col-sm-12">
                                            ...
                                            <div id="script_cobranza_mostrar">
                                                • Buenos días/Tardes mi nombre es <?php echo $nombre_usuario;?> , llamo de Claro Chile, necesito comunicarme con el encargado de pagos a proveedores de la empresa <b><span id="nombre_cliente"></span></b><br><br>
                                            </div>
                    ...
                    <!--Nav Tabs-->
                            ...
                            <div class="tab-content">
                                ...
                                <div id="demo-lft-tab-5" class="tab-pane fade">
                                    <div id="mostrar_gestion_diaria_ocultar">Gestiones del Dia</div>
