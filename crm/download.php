...
$constate1 = " SELECT fono_cob.Rut,CONCAT(Persona.Nombres, ' ', Persona.Apellido_Paterno , ' ', Persona.Apellido_Materno),fono_cob.formato_subtel,Deuda.Ano_Deuda,Deuda.Monto_Mora,Mejor_Gestion.Respuesta_N1,Mejor_Gestion.Fecha_Gestion,Mejor_Gestion.Fec_Compromiso,Mejor_Gestion.Monto_Compromiso,Mejor_Gestion.Observacion,fono_cob.color,fono_cob.cantidad_llamados FROM fono_cob,Persona,Deuda,Mejor_Gestion WHERE fono_cob.Rut IN (";
$constate2 = ")  AND fono_cob.Rut = Persona.Rut AND fono_cob.Rut = Deuda.Rut AND fono_cob.Rut = Mejor_Gestion.Rut GROUP BY fono_cob.formato_subtel ORDER BY fono_cob.Rut , fono_cob.color ASC";
