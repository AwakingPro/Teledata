                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker" id="estrategia" name="estrategia">
                                                ...
                                                <div class="form-group" id="templatepicker">
                                                    ...
                                                    <select class="selectpicker" id="template" name="template">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="col-sm-10">
                                                        <label for="cantidad-rut">Cantidad de Rut de la estrategia</label>
