                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                            <div class="form-group">
                                                                 <select class="selectpicker" id="opciones" multiple title="Seleccione" data-width="100%">
                                                                  <option>Seleccione</option>

                                                    <option> Supervisor Call
                                                    </option>

                                                    <option>Supervisor Acciones Complementarias</option>
                                                    <option>Masivo</option>
                                                    <option>Especialista</option>
                                                    <option>Ejecutivo Unico</option>
                                                       ...
                                                       <div class="col-sm-6">
                                                            <div class="form-group">
                                                               <select class="selectpicker" multiple title="Seleccione" data-width="100%">
                                                    <option>Empresa Externa 1</option>
                                                    <option>Empresa Externa 2</option>
                                        ...
                                        <table id="demo-dt-basic2" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                               <thead>
                                                <tr>
                                                 ...
                                                 <th class="min-desktop"><center>Desde</center></th>
                                                 <th class="min-desktop"><center>Hasta</center></th>
                                                 <th class="min-desktop"><center>Accion</center></th>
                                                 <th class="min-desktop"><center>Periodicidad</center></th>
                                                </tr>
                                               </thead>
                                              <tbody>
                                               <tr>
