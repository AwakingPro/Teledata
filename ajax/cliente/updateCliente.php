<?php
	...
	$query = "UPDATE personaempresa SET alias = '$Alias', CodigoCliente = '$CodigoCliente', nombre = '$Nombre', giro = '$Giro', direccion = '$DireccionComercial', correo = '$Correo', contacto = '$Contacto', comentario = '$Comentario', telefono = '$Telefono', tipo_cliente = '$TipoCliente', comuna = '$Comuna', ciudad = '$Ciudad' WHERE id = '$IdCliente'";
	$run = new Method;
