<?php
	...
	$query = "INSERT INTO servicio_internet (IdServicio, Velocidad, Plan, IdOrigen, IdProducto, TipoDestino) VALUES ('".$_POST['idServicio']."', '".$Velocidad."', '".$Plan."', '".$IdOrigen."', '".$IdProducto."', '".$TipoDestino."')";
	$run = new Method;
