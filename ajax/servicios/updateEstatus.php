<?php
    ...
    $dataClient['correos'] = 'jcarrillo@teledata.cl, rmontoya@teledata.cl, rmoreno@teledata.cl, jmellado@teledata.cl, fpezzuto@teledata.cl, pagos@teledata.cl, cvalenzuela@teledata.cl, esalas@teledata.cl';
